...
(function(r, i) {
    ...
    $.fn.cmd = function(e) {
        ...
        for (q = 65; q < 91; q++) {
            ...
            H[q] = [U.toLowerCase(), U.toUpperCase()]
        }
        var W = {};
        ...
        var J = {
            ...
            ENTER: function() {
                if (C && S && !x.mask && (is_function(x.historyFilter) && x.historyFilter(S) || x.historyFilter instanceof RegExp && S.match(x.historyFilter) || !x.historyFilter)) {
                    C.append(S)
                }
                var e = S;
                B.$node.blur();
        ...
        function ge(e) {
            ...
            if (h.length > 0) {
                for (var u = h.length; u > 0; u--) {
                    r = $.terminal.escape_regex(h.slice(0, u));
        ...
        $.extend(k, {
            ...
            name: function(e) {
                if (e !== undefined) {
                    y = e;
                    var t = C && C.enabled() || !C;
                    C = new History(y, x.historySize, x.history === "memory");
                    if (!t) {
                        C.disable()
                    }
                    return k
        ...
        function ot() {
            debug("input " + He + " || " + Ue + " ((" + Ne + " || " + ze + ") && !" + Je + " && (" + Pe + " || " + Me + ") && !" + qe + ")");
            var e = B.val();
            if (!is_mobile) {
                e = e.replace(/^ /, "")
            }
            if ((He || Ue || (Ne || ze) && !Je && (Pe || Me) && !qe) && e !== S) {
                var t = R;
                if (He) {
                    var n = Qe;
                    qe = n.slice(0, n.length - 1).length === e.length
                }
                if (at) {
                    at = false;
                    B.val(S);
    ...
    $.terminal = {
        ...
        format: function i(e, t) {
            ...
            function i(e, t, n, r, i, u, a) {
                ...
                if (p.length) {
                    D += "text-decoration:" + p.join(" ") + ";"
                }
                if (t.indexOf("i") !== -1) {
                    D += "font-style:italic;"
                }
                if ($.terminal.valid_color(n)) {
                    D += ["color:" + n, "--color:" + n, "--original-color:" + n].join(";") + ";";
                    if (t.indexOf("!") !== -1) {
                        D += "--link-color:" + n + ";"
                    }
                    if (t.indexOf("g") !== -1) {
                        D += "text-shadow:0 0 5px " + n + ";"
                    }
                }
                if ($.terminal.valid_color(r)) {
                    D += ["background-color:" + r, "--background:" + r].join(";") + ";"
                }
                var m = g(u, a);
                var d = extra_css(a, v);
                if (d) {
    ...
    $.fn.terminal = function(e, t) {
        ...
        function f(e) {
            ...
            } else if (is_function(Se.processArguments)) {
                return process_command(e, Se.processArguments)
            } else if (Se.processArguments) {
        ...
        function a(e, t) {
            if (is_function(Se.renderHandler)) {
                var n = Se.renderHandler.call(ue, e, t, ue);
                if (n === false) {
                    return false
                }
        ...
        function m(e) {
            if (is_function(Se.onRPCError)) {
                Se.onRPCError.call(ue, e)
            } else {
            ...
            var i = function(e, t) {
                ...
                $.jrpc({
                    ...
                    success: function e(t) {
                        if (t.error) {
                            m(t.error)
                        } else if (is_function(Se.processRPCResponse)) {
                            Se.processRPCResponse.call(ue, t.result, ue)
        ...
        function h(a, o, s, l) {
            return function(e, t) {
                ...
                if (i === "function") {
                    ...
                    l(e, ue)
                } else if (is_function(Se.onCommandNotFound)) {
                    Se.onCommandNotFound.call(ue, e, ue)
                } else {
        ...
        function v(e, t, n) {
            ue.resume();
            if (is_function(Se.onAjaxError)) {
                Se.onAjaxError.call(ue, e, t, n)
            } else if (t !== "abort") {
        ...
        function g(u, o, r) {
            function s(e) {
                if (e.error) {
                    ...
                    Se.processRPCResponse.call(ue, e.result, ue)
                } else {
                    D(e.result)
                }
                ue.resume()
            ...
            function e(e) {
                var n = e;
                if (Se.describe !== false && Se.describe !== "") {
                    Se.describe.split(".").forEach(function(e) {
                        n = n[e]
                    })
                }
                if (n && n.length) {
                    ...
                    $.each(n, function(e, i) {
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function() {
                                ...
                                if (Se.checkArity && i.params && i.params.length !== n) {
        ...
        function s(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    ...
                    n({
                        interpreter: h(o, false, a, l && l.bind(ue)),
                ...
                if (Se.describe === false) {
                    ...
                    if ($.isArray(Se.completion)) {
                        o.completion = Se.completion
                    }
                    n(o)
                } else {
                    ue.pause(Se.softPause);
                ...
                n({
                    interpreter: h(t, Se.checkArity, a),
        ...
        function _(e, t, n) {
            if (is_function(Se.exceptionHandler)) {
                Se.exceptionHandler.call(ue, e, t)
            } else {
                ue.exception(e, t);
                if (!n) {
                    setTimeout(function() {
        ...
        function F(e, t, n) {
            ...
            C.push(b);
            var u = {
                linksNoReferrer: Se.linksNoReferrer,
                linksNoFollow: Se.linksNoFollow,
                anyLinks: Se.anyLinks,
                char_width: Re.width,
                escape: false,
        ...
        function E(e, t) {
            return (strlen(text(e)) > t.cols || e.match(/\n/)) && (Se.wrap === true && t.wrap === undefined || Se.wrap === false && t.wrap === true)
        }
        var x;
        if ("Map" in root) {
            x = new Map
            ...
            try {
                ...
                if (e !== "") {
                    if (!r.raw) {
                        ...
                        if (r.formatters) {
                            try {
                                e = $.terminal.apply_formatters(e, $.extend(Se, {
                                    echo: true
                                }))
                            } catch (e) {
                                _(e, "FORMATTING")
                ...
                C = [];
                if (is_function(Se.exceptionHandler)) {
                    Se.exceptionHandler.call(ue, e, "TERMINAL")
                } else {
        ...
        function A(e) {
            ...
            try {
                ...
                if (is_function(Se.exceptionHandler)) {
                    Se.exceptionHandler.call(ue, e, "TERMINAL (redraw)")
                } else {
        ...
        function T() {
            if (Se.greetings === undefined) {
                ue.echo(ue.signature, {
                    finalize: a11y_hide,
                    formatters: false
                })
            } else if (Se.greetings) {
                var e = typeof Se.greetings;
                if (e === "string") {
                    ue.echo(Se.greetings)
                } else if (e === "function") {
                    try {
                        var t = Se.greetings.call(ue, ue.echo);
                        var n = O("Greetings");
                        unpromise(t, ue.echo, function(e) {
                            n(e);
                            Se.greetings = null
                        })
                    } catch (e) {
        ...
        function R() {
            return Ye.outerWidth() !== ue.outerWidth()
        }
        ...
        function P(n, e, t) {
            function r() {
                if (Se.historyState || Se.execHash && t) {
            ...
            function a() {
                var e = o.interpreter.call(ue, n, ue);
                if (e) {
                    if (!de) {
                        ue.pause(Se.softPause)
                    }
            ...
            try {
                if (U("onBeforeCommand", [n]) === false) {
                    return
                }
                if (t) {
                    ce = n.trim();
                    fe = $.terminal.split_command(ce)
                } else {
                    fe = $.terminal.split_command(n)
                }
                if (!Y()) {
                    if (t && (is_function(Se.historyFilter) && Se.historyFilter(n) || n.match(Se.historyFilter))) {
                        qe.history().append(n)
                    }
                }
                var o = He.top();
                ...
                if (n.match(/^\s*login\s*$/) && ue.token(true)) {
                    ...
                    i()
                } else if (Se.exit && n.match(/^\s*exit\s*$/) && !xe) {
                    var f = ue.level();
                    if (f === 1 && ue.get_token() || f > 1) {
                    ...
                    i()
                } else if (Se.clear && n.match(/^\s*clear\s*$/) && !xe) {
                    ue.clear();
                    i()
                } else {
                    var c = a();
        ...
        function N() {
            if (U("onBeforeLogout", [], true) === false) {
                return
            }
            M();
        ...
        function q(e) {
            ...
            if ($.isPlainObject(t.keymap)) {
                qe.keymap(null).keymap($.extend({}, ut, $.omap(t.keymap, function(e, t) {
                    return function() {
        ...
        function U(t, e, n) {
            ...
            } else if (is_function(Se[t])) {
                try {
                    return Se[t].apply(ue, e)
                } catch (e) {
                    Se[t] = null;
                    _(e, t)
                }
        ...
        function K() {
            ...
            return e.is_fully_in_viewport(ue).then(W)
        }

        function J() {
            if (fire_hash_change && Se.execHash) {
                try {
                    if (location.hash) {
        ...
        function Q() {
            ...
            var e = false;
            if (is_function(Se.onInit)) {
                ke = function() {
                    e = true
                };
                try {
                    Se.onInit.call(ue, ue)
                } catch (e) {
                    _(e, "OnInit")
                } finally {
                    ke = $.noop;
        ...
        function G(e) {
            ...
            } else if (is_function(Se.keydown)) {
                t = Se.keydown.call(ue, e, ue);
                if (t !== undefined) {
                    return t
                }
            }
        ...
        var V = {
            ...
            TAB: function(e, t) {
                ...
                if (typeof n.caseSensitiveAutocomplete !== "undefined") {
                    ...
                    i = Se.caseSensitiveAutocomplete
                }
                if (Se.completion && get_type(Se.completion) !== "boolean" && n.completion === undefined) {
                    r = Se.completion
                } else {
                    r = n.completion
                }
                ...
                function u(e) {
                    ...
                    if (!ue.before_cursor(false).match(/\s/)) {
                        if (Se.clear && $.inArray("clear", e) === -1) {
                            e.push("clear")
                        }
                        if (Se.exit && $.inArray("exit", e) === -1) {
                            e.push("exit")
                        }
                    }
                    ue.complete(e, {
                        echo: true,
                        word: Se.wordAutocomplete,
                        escape: Se.completionEscape,
                        caseSensitive: i,
                        echoCommand: Se.doubleTabEchoCommand,
                        doubleTab: Se.doubleTab
                    })
                }
                if (r) {
                    switch (get_type(r)) {
                        case "function":
                            var a = ue.before_cursor(Se.wordAutocomplete);
                            if (r.length === 3) {
                            ...
                            for (n = requests.length; n--;) {
                                ...
                                if (r.readyState !== 4) {
                                    try {
                                        ...
                                        if (is_function(Se.exceptionHandler)) {
                                            Se.exceptionHandler.call(ue, t, "AJAX ABORT")
                                        } else {
        ...
        function Z(e) {
            var t = He.top();
            if (ze && (!Ne || !Se.pauseEvents)) {
                if (is_function(t.keypress)) {
                    return t.keypress.call(ue, e, ue)
                } else if (is_function(Se.keypress)) {
                    return Se.keypress.call(ue, e, ue)
                }
            }
        }
        ...
        function ie() {
            return $.extend({}, $.terminal.defaults.strings, Se && Se.strings || {})
        }
        var ue = this;
        if (this.length > 1) {
            return this.each(function() {
        ...
        $.extend(ue, $.omap({
            ...
            import_view: function(t) {
                ...
                Fe(function e() {
                    ...
                    qe.position(t.position);
                    qe.mask(t.mask);
                    if (t.focus) {
                        ue.focus()
                    }
                    Le = clone(t.lines).filter(function(e) {
                        return e[0]
                    });
            ...
            save_state: function(e, t, n) {
                ...
                if (e !== undefined && !t) {
                    var r = [me, save_state.length - 1, e];
            ...
            login: function(r, i, u, a) {
                ...
                ue.on("terminal.autologin", function(e, t, n, r) {
                    if (U("onBeforeLogin", [t, n]) === false) {
                        return
                    }
                    s(t, n, r)
                });
                ue.push(function(n) {
                    ue.set_mask(Se.maskChar).push(function(e) {
                        try {
                            if (U("onBeforeLogin", [n, e]) === false) {
                                o();
                                return
                            }
                            ue.pause();
                    ...
                    if (++De >= 2) {
                        ...
                        if (i.echo) {
                            if (is_function(i.doubleTab)) {
                                ...
                                var p = i.doubleTab.call(ue, a, c, S);
            ...
            pause: function(t) {
                we(function e() {
                    ke();
                    Ne = true;
                    qe.disable(t || is_android);
                    if (!t) {
                        qe.find(".cmd-prompt").hidden()
                    }
                    U("onPause")
                });
                return ue
            ...
            resume: function(i) {
                we(function e() {
                    Ne = false;
                    if (ze && terminals.front() === ue) {
                        qe.enable(i)
                    }
                    qe.find(".cmd-prompt").visible();
                    var t = Te;
                    Te = [];
                    for (var n = 0; n < t.length; ++n) {
            ...
            cols: function() {
                ...
                if (typeof he === "undefined" || he === 1e3) {
                    he = get_num_chars(ue, Re)
                }
                return he
            },
            rows: function() {
            ...
            set_prompt: function(r, i) {
                ...
                Fe(function e() {
                    ...
                    if (t.typing) {
                        ...
                        var n = ue.typing("prompt", t.delay, r, t);
                        n.then(function() {
                            u.resolve()
                        })
                    }
            ...
            get_prompt: function() {
                return He.top().prompt
            },
            set_mask: function(t) {
                Fe(function e() {
                    qe.mask(t === true ? Se.maskChar : t)
                });
                return ue
            },
            ...
            resize: function(e, t) {
                if (!ue.is(":visible")) {
                    ...
                    e = ue.width();
                    t = ue.height();
                    if (typeof Se.numChars !== "undefined" || typeof Se.numRows !== "undefined") {
                        qe.resize(Se.numChars);
                        ue.refresh();
                        U("onResize");
                        return
                    }
                    var n = get_num_chars(ue, Re);
                    var r = get_num_rows(ue, Re);
                    if (n !== he || r !== ve) {
                        he = n;
                        ve = r;
                        qe.resize(he);
            ...
            refresh: function() {
                if (Re.width !== 0) {
                    ue[0].style.setProperty("--char-width", Re.width)
                }
                A({
                    scroll: false,
                    update: true
                ...
                try {
                    ...
                    while (C.length) {
                        ...
                        if (a === b) {
                            ...
                            r = false
                        } else if ($.isPlainObject(a) && is_function(a.finalize)) {
                            if (e.update) {
                                var o = "> div[data-index=" + a.index + "]";
                                var s = pe.find(o);
                                if (s.html() !== n.html()) {
                                    s.replaceWith(n)
                                }
                            ...
                            var f;
                            if (i) {
                                f = n.children().last().append(l);
                                i = false
                            } else {
                                f = $("<div/>").html(l);
                                if (a.newline) {
                                    f.addClass("cmd-end-line")
                                }
                                n.append(f)
                            }
                            f.css("width", "100%")
                    ...
                    var c = ue.find(".cmd-prompt");
                    var D = ue.find(".cmd");
                    u = ue.find(".partial");
                    if (u.length === 0) {
                        c.css("margin-left", 0);
                        D.css("top", 0);
                        qe.__set_prompt_margin(0)
                    } else {
                        var p = u.children().last();
                        p.css("width", "");
                        var m = p[0].getBoundingClientRect();
                        var d = m.width;
                        c.css("margin-left", d);
                        D.css("top", -m.height);
                        var h = ue.geometry().char.width;
                        var v = Math.round(d / h);
                        qe.__set_prompt_margin(v)
                    }
                    B();
                    U("onFlush");
                    var g = ue.find(".cmd-cursor");
                    var _ = ue.find(".cmd").offset();
                    var y = ue.offset();
                    setTimeout(function() {
                        css(ue[0], {
                            "--terminal-height": ue.height(),
                            "--terminal-x": _.left - y.left,
                            "--terminal-y": _.top - y.top,
                    ...
                    if (Se.scrollOnEcho && e.scroll || t) {
                        ue.scroll_to_bottom()
                    }
                } catch (e) {
                    if (is_function(Se.exceptionHandler)) {
                        try {
                            Se.exceptionHandler.call(ue, e, "TERMINAL (Flush)")
                        } catch (e) {
                            Se.exceptionHandler = $.noop;
                ...
                function t(l) {
                    try {
                        var f = $.extend({
                            ...
                            typing: false,
                            keepWords: false,
                            invokeMethods: Se.invokeMethods,
                            onClear: null,
                            formatters: true,
                            allowedAttributes: Se.allowedAttributes,
                            newline: true
                        }, r || {});
                        (function(t) {
                            f.finalize = function(e) {
                                if (f.raw) {
                                    e.addClass("raw")
                                }
                                if (f.ansi) {
                        ...
                        if (U("onBeforeEcho", [l]) === false) {
                            return
                        }
                        if (f.typing) {
                            if (typeof l !== "string") {
                                return u.reject("echo: Typing animation require string" + " or promise that resolve to string")
                            }
                            if (typeof f.delay !== "number" || isNaN(f.delay)) {
                                return u.reject("echo: Invalid argument, delay need to" + " be a number")
                            }
                            var e = ue.typing("echo", f.delay, l, f);
                            e.then(function() {
                                u.resolve()
                            })
                        }
                        ...
                        unpromise(t, function(e) {
                            ...
                            var t = Le[Le.length - 1];
                            var n = Le.length === 0 || t[1].newline;
                            var r = Le.length;
                            if (!n) {
                                r--
                            }
                            if (!f.newline && e[e.length - 1] === "\n") {
                                e = e.slice(0, -1);
                                f.newline = true
                            }
                            var i = k({
                        ...
                        if (is_function(Se.exceptionHandler)) {
                            Se.exceptionHandler.call(ue, e, "TERMINAL (echo)")
                        } else {
            ...
            token: function(e) {
                return Ie.get(ue.prefix_name(e) + "_token")
            },
            ...
            login_name: function(e) {
                return Ie.get(ue.prefix_name(e) + "_login")
            },
            name: function() {
                return He.top().name
            },
            prefix_name: function(e) {
                var t = (Se.name ? Se.name + "_" : "") + me;
                if (e && He.size() > 1) {
                    var n = He.map(function(e) {
                        return e.name || ""
                    }).slice(1).join("_");
                    if (n) {
                        t += "_" + n
                    ...
                    s(a, o.login, function(e) {
                        ...
                        if (r.completion === true) {
                            if ($.isArray(e.completion)) {
                                He.top().completion = e.completion
                            } else if (!e.completion) {
                                He.top().completion = false
                            }
                        }
                        if (r.login) {
                            var t;
                            ...
                            if (n === "function") {
                                ...
                                t = r.infiniteLogin ? $.noop : ue.pop;
                                ue.login(l(a, r.login), r.infiniteLogin, u, t)
                            }
                        } else {
                            u()
                        }
            ...
            keymap: function(e, n) {
                ...
                if (typeof n === "undefined") {
                    if (typeof e === "string") {
                        ...
                        e = $.extend({}, ut, $.omap(e || {}, function(n, r) {
                            if (!ut[n]) {
                                return r.bind(ue)
                            }
                            return function(e, t) {
                        ...
                        qe.keymap(null).keymap(e)
                    }
                } else if (typeof n === "function") {
                    var r = e;
                    if (!ut[r]) {
                        qe.keymap(r, n.bind(ue))
                    } else {
                        qe.keymap(r, function(e, t) {
            ...
            purge: function() {
                Fe(function e() {
                    ...
                    var n = Ie.get(t + "interpreters");
                    if (n) {
                        $.each(JSON.parse(n), function(e, t) {
                            Ie.remove(t + "_commands");
                            Ie.remove(t + "_token");
                            Ie.remove(t + "_login")
                        })
                    }
                    qe.purge();
                    Ie.remove(t + "interpreters")
                });
                return ue
            },
            destroy: function() {
                Fe(function e() {
                    ...
                    $(window).off("blur", tt).off("focus", et);
        ...
        if (ue.length === 0) {
            var se = sprintf(ie().invalidSelector);
        ...
        var Ae, Be;
        var Te = [];
        var Se = $.extend({}, $.terminal.defaults, {
            name: ue.selector,
            exit: !!(t && t.login || !t)
        }, t || {});
        if (typeof Se.width === "number") {
            ue.width(Se.width)
        }
        if (typeof Se.height === "number") {
            ue.height(Se.height)
        }
        var Re = get_char_size(ue);
        var je = !terminal_ready(ue);
        delete Se.formatters;
        var Oe = false;
        var Le = [];
        var Ie = new n(Se.memory);
        var ze = Se.enabled;
        var Pe = false;
        var Ne = false;
        var Me = true;
        ...
        var We;
        var Ke;
        if (Se.ignoreSystemDescribe === true) {
            Se.describe = false
        }
        $(document).bind("ajaxSend.terminal_" + ue.id(), function(e, t) {
            requests.push(t)
        });
        var Je = $('<div class="terminal-wrapper"/>').appendTo(ue);
        $(broken_image).hide().appendTo(Je);
        var Qe = $('<div class="terminal-font">&nbsp;</div>').appendTo(ue);
        var Ye = $('<div class="terminal-fill"/>').appendTo(ue);
        pe = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(Je);
        ue.addClass("terminal");
        if (Se.login && U("onBeforeLogin") === false) {
            Me = false
        }
        var Ge;
        if (typeof e === "string") {
            ...
            for (var Ve = 0, Xe = e.length; Ve < Xe; ++Ve) {
                if (typeof e[Ve] === "string") {
                    Ge = e[Ve];
                    break
                }
            }
        ...
        var Ze;
        if (is_function(Se.login)) {
            Ze = Se.login
        } else if (Ge && (typeof Se.login === "string" || Se.login === true)) {
            Ze = l(Ge, Se.login)
        }
        terminals.append(ue);
        ...
        function nt(e) {
            ...
            if (get_type(e) !== "string") {
                if (is_function(Se.parseObject)) {
                    var t = Se.parseObject(e);
                    if (get_type(t) === "string") {
                        e = t
                    }
                } else if (is_array(e)) {
                    e = $.terminal.columns(e, ue.cols(), Se.tabs)
                } else {
                    e = String(e)
                }
            }
        ...
        $(document).on("paste.terminal_" + ue.id(), it);
        var ut = $.extend({}, V, $.omap(Se.keymap || {}, function(n, r) {
            if (!V[n]) {
                return r.bind(ue)
            }
            return function(e, t) {
        ...
        s(e, Se.login, function(e) {
            if (Se.completion && typeof Se.completion !== "boolean" || !Se.completion) {
            ...
            He = new Stack($.extend({}, Se.extra, {
                name: Se.name,
                prompt: t,
                keypress: Se.keypress,
                keydown: Se.keydown,
                resize: Se.onResize,
                greetings: Se.greetings,
                mousewheel: Se.mousewheel,
                history: Se.history,
                keymap: ut
            }, e));
            qe = $("<div/>").appendTo(Je).cmd({
                tabindex: Se.tabindex,
                mobileDelete: Se.mobileDelete,
                mobileIngoreAutoSpace: Se.mobileIngoreAutoSpace,
                prompt: Ze ? false : t,
                history: Se.memory ? "memory" : Se.history,
                historyFilter: Se.historyFilter,
                historySize: Se.historySize,
                caseSensitiveSearch: Se.caseSensitiveSearch,
                onPaste: Se.onPaste,
                width: "100%",
                enabled: false,
                char_width: Re.width,
                keydown: X,
                keymap: ut,
                clickTimeout: Se.clickTimeout,
                holdTimeout: Se.holdTimeout,
                holdRepeatTimeout: Se.holdRepeatTimeout,
                repeatTimeoutKeys: Se.repeatTimeoutKeys,
                allowedAttributes: Se.allowedAttributes,
                keypress: Z,
                tabs: Se.tabs,
            ...
            if (is_mobile) {
                ...
                r.on("focus.terminal_" + ue.id(), et).on("blur.terminal_" + ue.id(), tt);
                var h;
                (function() {
                    var t = 0;
                    var n;
                ...
                (function() {
                    ...
                    ue.on(e, function(e) {
                        ...
                        if (h) {
                            ...
                            var n = qe.offset();
                            var r = qe[0].getBoundingClientRect();
                            var i = ue.offset();
                            var u = i.top - n.top;
            ...
            function i() {
                ...
                Re = get_char_size(ue);
                if (e !== Re.width) {
                    qe.option("char_width", Re.width).refresh()
                }
            }
            u();
            ...
            function a() {
                ...
                Qe.resizer("unbind").resizer(function() {
                    i();
                    ue.resize()
                }, e)
            }
            ...
            function l() {
                ...
                if (window.IntersectionObserver && ue.css("position") !== "fixed") {
                    We = new IntersectionObserver(n, {
                        root: null
                    });
                    We.observe(ue[0])
                } else {
                    We = setInterval(n, 100)
                }
            }
            ...
            if (Se.execHash) {
                ...
                function n(e, t) {
                    if (!i) {
                        ...
                        } else if (is_function(Se.mousewheel)) {
                            r = Se.mousewheel(e, t, ue)
                        }
                        if (r === true) {
                            return
                        }
                ...
                ue.touch_scroll(function(e) {
                    ...
                    } else if (is_function(Se.touchscroll)) {
                        n = Se.touchscroll(e, t, ue)
                    }
                    css(ue[0], {
                        "--terminal-scroll": ue.prop("scrollTop")
                    });
